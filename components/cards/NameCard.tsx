export function NameCard() {
  return (
    <div className="relative col-span-2 row-span-1 card-base p-8 overflow-hidden">
      ...
      <div className="relative flex flex-col justify-between h-full">
        <div>
          <p className="font-mono text-[10px] text-neon/50 mb-4 tracking-wider">
            &gt; whoami
          </p>
        ...
        <p className="font-mono text-xs text-neon/40 mt-6">
