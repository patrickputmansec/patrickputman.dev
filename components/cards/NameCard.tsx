  ...
  return (
    <div className="relative col-span-2 row-span-1 rounded-2xl border border-edge bg-panel p-8 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="absolute top-[10%] left-[15%] w-[300px] h-[300px] rounded-full bg-bolt/[0.05] blur-[100px] animate-glow-drift-1" />
        <div className="absolute top-[30%] right-[10%] w-[250px] h-[250px] rounded-full bg-bolt/[0.03] blur-[80px] animate-glow-drift-2" />
      </div>
